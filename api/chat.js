...
${lesson.content || ""}`;
  ...
  return base + language + rules + modeling + context;
}
...
return base + language + identity + roleAwareness + style + nextStep + levelGuidance + bridge + rhythm + modeling + compass + boundaries + context + attachedFileSection + bandsProgress + bandDialogue + foresight + learningBridge + journey;
}
