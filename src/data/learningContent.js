...
export const learningContent = {
  1: {
    title: 'إعداد البيئة',
    intro: 'أهلاً بك. سأرافقك من أول خطوة حتى تبني مشروعك وتنشره. لنبدأ بتجهيز جهازك بالأدوات الأساسية — تُبنى مرة واحدة، وتخدمك في كل مشاريعك القادمة.',
    sections: [
      {
        title: 'تثبيت Node.js',
      ...
      {
        title: 'إنشاء مشروعك',
        subtitle: '3 أوامر فقط تُنشئ هيكل تطبيقك كاملاً',
        steps: [
          { type: 'text', text: 'الآن تبدأ ببناء مشروعك أنت. سننشئ تطبيق React جديداً بأداة Vite السريعة. افتح cmd في المكان الذي تريد مشروعك فيه.' },
          { type: 'instruction', icon: '💻', text: 'اكتب هذا الأمر لإنشاء مشروعك — واختر اسماً يعبّر عن فكرتك بدل my-app:' },
          { type: 'code', text: 'npm create vite@latest my-app -- --template react' },
          { type: 'tip', text: 'اسم المشروع لك أنت — اختر ما يناسب فكرتك (مثل: my-store أو tasks-app). فقط تجنّب المسافات والحروف العربية في الاسم.' },
          { type: 'instruction', icon: '📂', text: 'ادخل إلى مجلد مشروعك (استبدل my-app باسمك الذي اخترته):' },
          { type: 'code', text: 'cd my-app' },
          { type: 'instruction', icon: '⬇️', text: 'ثبّت المكتبات الأساسية:' },
          { type: 'code', text: 'npm install' },
          { type: 'tip', text: 'هذه الأوامر الثلاثة تُنشئ هيكل تطبيق React كاملاً جاهزاً للعمل — أساس مشروعك.' },
        ],
      },
      {
        title: 'شغّل مشروعك للمرة الأولى',
        subtitle: 'ترى تطبيقك يعمل في المتصفّح',
        steps: [
